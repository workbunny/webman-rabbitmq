...
class TestRequeueBuilder extends QueueBuilder
{
    ...
    protected array $queueConfig = [
        // 队列名称 ，默认由类名自动生成
        'name'           => 'process.workbunny.rabbitmq.TestRequeueBuilder',
        // 是否延迟
        'delayed'        => false,
        // QOS 数量
        'prefetch_count' => 0,
    ...
    protected ?string $exchangeName = 'process.workbunny.rabbitmq.TestRequeueBuilder';
    ...
    {
        if ($message->getHeader('workbunny-requeue-count', 0) >= 5) {
            file_put_contents(
                self::$logFile,
                json_encode([
                    ...
                    'workbunny-requeue-count' => $message->getHeader('workbunny-requeue-count'),
